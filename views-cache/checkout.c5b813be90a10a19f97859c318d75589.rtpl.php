									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												...
												<label class="" for="billing_state"><img style="height: 64px;" src="/res/site/img/logo-pagseguro.png" alt="Pagamento Pagseguro"></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" id="method-paypal" name="payment-method" placeholder="Paypal" value="2" style="float: left; margin: 30px;">
												<label class="" for="billing_state"><img style="height: 64px;" src="/res/site/img/logo-paypal.png" alt="Pagamento Paypal"></label>
											</p>
											<div id="payment">
