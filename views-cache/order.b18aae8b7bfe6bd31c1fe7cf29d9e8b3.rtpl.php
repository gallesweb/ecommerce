    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <address>
                ...
                <?php echo utf8_encode($order["desaddress"]); ?> <?php echo utf8_encode($order["desnumber"]); ?>, <?php echo utf8_encode($order["descomplement"]); ?> - <?php echo utf8_encode($order["desdistrict"]); ?><br>
                <?php echo utf8_encode($order["descity"]); ?> - <?php echo utf8_encode($order["desstate"]); ?> - CEP:<?php echo utf8_encode($order["deszipcode"]); ?><br>
